...
{
  fprintf(stderr, "Roller code for AbanQ v2"
          "\n(c) 2003-20012 InfoSiAL S.L.\n\n"
          "Usage:\n"
          "    roller [options] script-src.qs [-out script-rolled.rld]\n"
          "Options:\n"
          "    -utf8\n"
...
int main(int argc, char **argv)
{
  ...
  for (i = 1; i < argc; i++) {
    ...
    if (outputFile.isEmpty())
      outputFile = QString::fromLatin1(argv[ i ]) + ".rld";
    ...
    QString outText(AQRoller::roll(fullText, QString::fromLatin1(argv[ i ])));
    tdst << outText;

    break;
  }

  fprintf(stderr, "Generated rolled code in %s\n", outputFile.latin1());
